...
class UIBugFixTest {
    ...
    @Test
    fun `bug 1 - reset button should not be available when timer is idle`() {
        // Test that reset button is not available in idle state
        ...
        // Verify reset button should not be available when idle
